...
test_idx = np.load('/mnt/workspace/xuhan/github-repo/chemprop-master/small_dataset_test/slim-schnet/test_id.npy')
...
pretrained_dict = torch.load('/mnt/workspace/xuhan/github-repo/chemprop-master/small_dataset_test/slim-schnet/qm9/valid_checkpoint.pt')['model_state_dict']
...
run3d.run(device, train_data, valid_data, test_data, model, loss_func, evaluation,
          ...
          lr_decay_factor=0.5, lr_decay_step_size=300, softnet=True, 
          save_dir='./benzene2017/transfer/'
          )
