...
from slimnet.chemprop.data import utils
from slimnet.chemprop.data import set_cache_mol
from slimnet.chemprop.features import get_available_features_generators
...
class CommonArgs(Tap):
    ...
    outputmode: Literal['arr','vtf','slimnet'] = None
    """Whether to output SoftNET, arrhenius or vtf parameters"""
...
class TrainArgs(CommonArgs):
    ...
    def process_args(self) -> None:
        ...
        self.smiles_columns = utils.preprocess_smiles_columns(
            path=self.data_path,
