...
from ..utils import build_optimizer, build_lr_scheduler, get_loss_func, load_checkpoint, makedirs, \
...
def run_training(args: TrainArgs,
    ...
    if args.dataset_type == 'regression' and args.outputmode==None:
    ...
    if args.dataset_type == 'multiclass':
        ...
        if args.outputmode=='arr':
            ...
            sum_test_preds = np.zeros((len(test_smiles), 4))
        elif args.outputmode=='vtf':
    ...
    for model_idx in range(args.ensemble_size):
        ...
        if args.outputmode is not None:
            ...
            test_preds = fits_to_conds(test_preds,test_temps,args.outputmode)
